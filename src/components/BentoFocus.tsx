...
export default function BentoFocus({ onSelectOpportunityType }: BentoFocusProps) {
  return (
    <section className="py-20 md:py-32 bg-white" id="focus">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        >
          ...
          <h2 className="font-sans text-2xl sm:text-3xl md:text-5xl font-semibold tracking-tight text-[#1a3929]">
        ...
        >
          <div
            ...
            className="md:col-span-2 group relative aspect-[5/6] sm:aspect-[4/3] md:aspect-[16/9] overflow-hidden bg-[#0e2116] shadow-sm cursor-pointer"
          >
            <img
            ...
            <div className="absolute bottom-0 left-0 p-5 sm:p-6 md:p-12 text-white">
              <span className="font-sans text-[10px] font-bold tracking-[0.2em] text-[#c4a25a] uppercase block mb-2">
                CORE ASSET ALLOCATION
              </span>
              <h3 className="font-sans text-xl sm:text-2xl md:text-3xl font-semibold mb-3 tracking-tight">
                Real Estate Partnerships
              </h3>
              <p className="font-serif text-[13px] sm:text-sm md:text-base text-white/70 leading-relaxed max-w-lg font-light">
            ...
            <div className="absolute top-4 right-4 md:top-6 md:right-6 p-3 bg-[#c4a25a]/20 backdrop-blur-md border border-[#c4a25a]/40 text-[#d4b472] opacity-0 group-hover:opacity-100 transition-all duration-300">
          ...
          <div
            ...
            className="group block border border-neutral-200/80 p-6 sm:p-8 md:p-10 flex flex-col justify-between hover:border-[#1a3929]/40 transition-all duration-300 shadow-sm cursor-pointer relative overflow-hidden"
          >
            ...
            <div className="relative">
              <div className="p-4 bg-[#f3f9f4] group-hover:bg-[#1a3929] transition-colors duration-300 inline-block rounded-lg mb-6 md:mb-8 text-[#1a3929] group-hover:text-[#c4a25a]">
                <Building2 className="w-8 h-8" />
              </div>
              <h3 className="font-sans text-xl md:text-2xl font-semibold mb-3 text-[#1a3929] tracking-tight">
                Private Lending
              </h3>
              <p className="font-sans text-2xl sm:text-3xl font-bold text-[#c4a25a] mb-3 tracking-tight">12%+ p.a.</p>
              <p className="font-serif text-sm md:text-base text-neutral-500 leading-relaxed font-light">
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="font-sans text-2xl sm:text-3xl font-bold text-[#c4a25a] mb-3 tracking-tight">$500K-$1.5M ARR</p>
              <p className="font-serif text-sm md:text-base text-neutral-500 leading-relaxed font-light">
                Acquiring and scaling Managed Service Providers and MSSPs in key areas of Vancouver, Toronto, Miami, New York and Los Angeles.
              </p>
            </div>
            <div className="relative mt-8 border-t border-neutral-200/60 pt-6">
              <span className="font-sans text-[11px] font-bold tracking-widest text-[#1a3929] uppercase flex items-center gap-2 group-hover:gap-4 group-hover:text-[#c4a25a] transition-all duration-300">
          ...
          <div
            ...
            className="md:col-span-2 group min-h-[320px] bg-[#1a3929] text-white p-6 sm:p-8 md:p-12 flex flex-col md:flex-row items-start md:items-center gap-8 md:gap-10 shadow-lg cursor-pointer transition-colors duration-350 relative overflow-hidden"
          >
            <div
            ...
            <div className="flex-1 flex flex-col justify-center relative">
              ...
              <h3 className="font-sans text-xl sm:text-2xl md:text-3xl font-semibold mb-4 tracking-tight text-white">
                Venture Capital
              </h3>
              <p className="font-serif text-sm md:text-base text-white/65 leading-relaxed mb-8 font-light">
            ...
            <div className="w-full md:w-1/3 aspect-[4/3] sm:aspect-square bg-white/5 border border-white/10 group-hover:border-[#c4a25a]/30 p-6 sm:p-8 flex items-center justify-center relative overflow-hidden transition-colors duration-500">
